...
@section("breadcrumbs")
    {{ Breadcrumbs::render('customers.all') }}
@endsection

@section("content")
    <x-page-container class="py-5">
        <div class="flex items-center justify-between mb-4 md:mb-6">
            <h1 class="font-display font-bold text-2xl text-gray-700">Customers</h1>
            <a href="{{ route("customers.create") }}" class="btn success">
        ...
        @if(! $customers->count())
            <p class="py-6 font-body text-gray-400 text-center leading-none">
                ...
                You do not have any customers. To create one, click on the New button.
            </p>
        @endif
